...
import io.particle.android.sdk.devicesetup.setupsteps.SaveDeviceStep;
...
public class ConnectingActivity extends RequiresWifiScansActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectingProcessWorkerTask = new ConnectingProcessWorkerTask(this, buildSteps(), 5);
    ...
    private List<SetupStep> buildSteps() {
        ...
        SaveDeviceStep saveDeviceStep = setupStepsFactory.newSaveDeviceStep(sparkCloud, DeviceSetupState.deviceToBeSetUpId, this);
