...
public class DiscoverDeviceActivity extends RequiresWifiScansActivity
    ...
    private static final int MAX_NUM_DISCOVER_PROCESS_ATTEMPTS = 3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Ui.findView(this, R.id.action_log_out).setVisibility(BaseActivity.setupOnly ? View.GONE : View.GONE);
    }
    ...
    private void onWifiDisabled() {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.enable_wifi, (dialog, which) -> {
                    ...
                    wifiListFragment.setPage(WifiListFragment.PAGE_TYPE.SCAN_PHOTON);
    ...
    private void onDeviceClaimedByOtherUser() {
        String dialogMsg = getString(R.string.dialog_title_owned_by_another_user,
                getString(R.string.ctrl_name), sparkCloud.getLoggedInUsername());
