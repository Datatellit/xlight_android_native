...
public class ScenarioItemAdapter extends BaseAdapter {
    ...
    public ScenarioItemAdapter(Context context, List<Devicenodes> deviceList, boolean supportEvent) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ScenarioItemAdapter.ViewHolder holder = null;
        if (convertView == null) {
            holder = new ScenarioItemAdapter.ViewHolder();
            convertView = inflater.inflate(R.layout.activity_add_scene_item, null);
            ...
            holder = (ScenarioItemAdapter.ViewHolder) convertView.getTag();
        }
        ...
        if (support) {
            if (device.ison == 0) {
                ...
                holder.state.setText(R.string.scene_close);
                holder.state.setVisibility(View.VISIBLE);
            } else {
                holder.brightness.setVisibility(View.VISIBLE);
                holder.ll_item.setBackgroundResource(R.drawable.layout_radius);
